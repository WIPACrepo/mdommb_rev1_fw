...
#
# Generated by export_simulation on Sat May 24 15:42:54 -0700 2025
#
################################################################################
...
'-reset_run' switch to the './HBUF_DDR3_PG_DOUBLE_BUFFER.sh' script.

./HBUF_DDR3_PG_DOUBLE_BUFFER.sh -reset_run
...
./HBUF_DDR3_PG_DOUBLE_BUFFER.sh -noclean_files

For more information on the script, please type './HBUF_DDR3_PG_DOUBLE_BUFFER.sh -help'.
