...
#
# Generated by export_simulation on Sun Jun 15 22:12:12 -0700 2025
#
################################################################################
...
'-reset_run' switch to the './OVERFLOW_FIFO.sh' script.

./OVERFLOW_FIFO.sh -reset_run
...
./OVERFLOW_FIFO.sh -noclean_files

For more information on the script, please type './OVERFLOW_FIFO.sh -help'.
