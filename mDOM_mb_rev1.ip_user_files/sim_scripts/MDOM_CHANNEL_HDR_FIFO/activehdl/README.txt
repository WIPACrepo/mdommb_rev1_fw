...
#
# Generated by export_simulation on Sun May 18 01:10:57 -0700 2025
#
################################################################################
...
'-reset_run' switch to the './MDOM_CHANNEL_HDR_FIFO.sh' script.

./MDOM_CHANNEL_HDR_FIFO.sh -reset_run
...
./MDOM_CHANNEL_HDR_FIFO.sh -noclean_files

For more information on the script, please type './MDOM_CHANNEL_HDR_FIFO.sh -help'.
